...
export default function Library() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white px-6 py-10 pb-24">
      <div className="max-w-6xl mx-auto">
        ...
        {songs.length === 0 ? (
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {songs.map((song) => (
              <div key={song.id} className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition">
                <img src={song.image} alt={song.title} className="w-full h-48 object-cover rounded-md mb-4" />
      ...
      <MiniPlayer song={currentSong} onClose={() => setCurrentSong(null)} />
    </div>
  );
}
